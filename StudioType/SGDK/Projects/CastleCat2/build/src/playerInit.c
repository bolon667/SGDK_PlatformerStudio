...
void playerInit(Vect2D_s16 levelStartPos) {
	...
	playerBody.debugSpr1 = SPR_addSprite(&spr_debugLeftTopCorner, levelStartPos.x, levelStartPos.y, TILE_ATTR(PAL3, 11, FALSE, FALSE));
	...
	playerBody.aabb = newAABB(9, 34, 17, 48);
