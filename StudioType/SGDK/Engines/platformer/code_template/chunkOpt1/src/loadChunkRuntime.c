...
void loadChunkRuntime(){
	//Not really runtime, i want to optimize this algorithm
	//I wanna load only line of chunks, not whole screen of chunks.
	//This is more like loadChunkFull, useful for loadLevel function.
