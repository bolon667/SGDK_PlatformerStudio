...
const Trigger const Trigger_arr_Level_0[] = {{TRUE, {235, 152}, {0, 0, 64, 64}, 0, 0, 1, }, };
const EntityMerged const EntityMerged_arr_Level_0[] = {{0, TRUE, {235, 152}, {FIX32(235), FIX32(152)}, {0, 0}, {32, 32}, FALSE, NULL,&Trigger_arr_Level_0[0],&spr_enemy01, }, };
const EntityAll const EntityAll_arr_Level_0[] = {1, &EntityMerged_arr_Level_0, 1, &Trigger_arr_Level_0, };
const LevelFull const LevelFull_arr[] = {{{&Level_1_bga_map, NULL, &Level_1_bga_tileset, NULL, &Level_1_bga_pal, NULL, {87, 41}, collisionMap, {320, 224}, {20, 14}},&EntityAll_arr_Level_0}, };
