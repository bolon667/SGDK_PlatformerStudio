...
const Trigger const Trigger_arr_Level_0[] = {{TRUE, {288, 6}, {0, 0, 30, 200}, 0, 1, 1, }, {TRUE, {233, 90}, {0, 0, 8, 8}, 0, 0, 1, }, {TRUE, {111, 57}, {0, 0, 8, 8}, 0, 0, 1, }, {TRUE, {31, 92}, {0, 0, 8, 8}, 0, 0, 1, }, };
const EntityMerged const EntityMerged_arr_Level_0[] = {{0, TRUE, {288, 6}, {FIX32(288), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_0[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {233, 90}, {FIX32(233), FIX32(90)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_0[1],1,NULL,&spr_enemy01, 1, 0, }, {0, TRUE, {111, 57}, {FIX32(111), FIX32(57)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_0[2],2,NULL,&spr_explode, 1, 0, }, {0, TRUE, {31, 92}, {FIX32(31), FIX32(92)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_0[3],3,NULL,&spr_enemy02, 1, 0, }, };
...
const Trigger const Trigger_arr_Level_1[] = {{TRUE, {301, 7}, {0, 0, 20, 200}, 0, 2, 1, }, {TRUE, {170, 4}, {0, 0, 8, 8}, 0, 0, 1, }, };
const EntityMerged const EntityMerged_arr_Level_1[] = {{0, TRUE, {301, 7}, {FIX32(301), FIX32(7)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_1[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {170, 4}, {FIX32(170), FIX32(4)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_1[1],1,NULL,&spr_enemy02, 1, 0, }, };
const EntityAll const EntityAll_arr_Level_1[] = {2, &EntityMerged_arr_Level_1, 2, &Trigger_arr_Level_1, };
...
const Trigger const Trigger_arr_Level_2[] = {{TRUE, {301, 4}, {0, 0, 20, 200}, 0, 3, 1, }, {TRUE, {167, 78}, {0, 0, 8, 8}, 0, 0, 1, }, };
const EntityMerged const EntityMerged_arr_Level_2[] = {{0, TRUE, {301, 4}, {FIX32(301), FIX32(4)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_2[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {167, 78}, {FIX32(167), FIX32(78)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_2[1],1,NULL,&spr_enemy01, 1, 0, }, };
const EntityAll const EntityAll_arr_Level_2[] = {2, &EntityMerged_arr_Level_2, 2, &Trigger_arr_Level_2, };
...
const Trigger const Trigger_arr_Level_3[] = {{TRUE, {300, 4}, {0, 0, 20, 200}, 0, 4, 1, }, {TRUE, {119, 56}, {0, 0, 8, 8}, 0, 0, 1, }, };
const EntityMerged const EntityMerged_arr_Level_3[] = {{0, TRUE, {300, 4}, {FIX32(300), FIX32(4)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_3[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {119, 56}, {FIX32(119), FIX32(56)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_3[1],1,NULL,&spr_enemy02, 1, 0, }, };
const EntityAll const EntityAll_arr_Level_3[] = {2, &EntityMerged_arr_Level_3, 2, &Trigger_arr_Level_3, };
...
const EntityMerged const EntityMerged_arr_Level_4[] = {{0, TRUE, {298, 2}, {FIX32(298), FIX32(2)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_4[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {129, 61}, {FIX32(129), FIX32(61)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_4[1],1,NULL,&spr_enemy01, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_5[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_5[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {87, 1}, {FIX32(87), FIX32(1)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_5[1],1,NULL,NULL, 1, 0, }, {0, TRUE, {229, 39}, {FIX32(229), FIX32(39)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_5[2],2,NULL,&spr_enemy02, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_6[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_6[0],0,NULL,NULL, 1, 0, }, {0, TRUE, {141, 49}, {FIX32(141), FIX32(49)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_6[1],1,NULL,&spr_enemy01, 1, 0, }, {0, TRUE, {200, 47}, {FIX32(200), FIX32(47)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_6[2],2,NULL,&spr_noSpr, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_7[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_7[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_8[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_8[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_9[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_9[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_10[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_10[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_11[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_11[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_12[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_12[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_13[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_13[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_14[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_14[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_15[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_15[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_16[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_16[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_17[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_17[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_18[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_18[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_19[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_19[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_20[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_20[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_21[] = {{0, TRUE, {299, 6}, {FIX32(299), FIX32(6)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_21[0],0,NULL,NULL, 1, 0, }, };
...
const EntityMerged const EntityMerged_arr_Level_22[] = {{0, TRUE, {5, 221}, {FIX32(5), FIX32(221)}, {0, 0}, {32, 32}, FALSE, &Trigger_arr_Level_22[0],0,NULL,NULL, 1, 0, }, };
