...
func _on_TextEdit_text_changed():
	...
	match fieldName:
		"Trigger rect":
			...
			singleton.entity_types["defs"][entityCollectionDef][singleton.cur_entity_type_ind]["triggerAABB"] = result_arr
		"Trigger type":
			singleton.entity_types["defs"][entityCollectionDef][singleton.cur_entity_type_ind]["triggerType"] = int(fieldPropertyValue)
		"Trigger value":
			singleton.entity_types["defs"][entityCollectionDef][singleton.cur_entity_type_ind]["triggerValue"] = int(fieldPropertyValue)
