...
func _on_TextEdit_text_changed():
	...
	singleton.change_cur_field(entityCollection, fieldPropertyName, fieldPropertyValue)
	...
	match fieldName:
		"Trigger rect":
			...
			singleton.entity_types["defs"][entityCollection][singleton.cur_entity_type_ind]["triggerAABB"] = result_arr
		"Trigger type":
			singleton.entity_types["defs"][entityCollection][singleton.cur_entity_type_ind]["triggerType"] = int(fieldPropertyValue)
		"Trigger value":
			singleton.entity_types["defs"][entityCollection][singleton.cur_entity_type_ind]["triggerValue"] = int(fieldPropertyValue)
