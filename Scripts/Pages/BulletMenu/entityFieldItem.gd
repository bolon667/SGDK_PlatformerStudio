...
func _on_DeleteBtn_button_down():
	...
	singleton.delete_fieldDef("bulletEntities", "entityBulletInstances", cur_field_ind)
...
func _on_TextBtn_button_down():
	...
	get_tree().call_group("bulletMenu", "load_field_properties", singleton.cur_entity_type, field_name)
